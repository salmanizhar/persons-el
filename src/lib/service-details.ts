export const serviceDetails: Record<string, string> = {
  elinstallation:
    "Vi planerar kabeldragning, placering och kapacitet efter bostadens eller lokalens förutsättningar. Arbetet utförs med fokus på säkerhet, tydlig dokumentation och en installation som är enkel att använda och underhålla.",
  belysning:
